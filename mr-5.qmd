...
- Random effects are not often thought of during normal experimental design considerations. Ie is the stimulus fixed vs random? See Judd, Westfall & Kenny 2012).
...
- In an ANOVA context where the random effect is level/group the partial pooling is less. But if you are nesting within people, there will be more partial pooling/shrinkage/learning from other nested units. 
