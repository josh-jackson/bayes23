...
::: incremental
-   So why use it? Many reasons, but the most direct is manipulating, visualizing, and extrapolating from results. Others include better convergence, able to include regularization, easier to simulate - plus many more
:::
...
::: incremental
-   Is it a philosophically different frame work? We can talk about how it is p(H0\|d) vs p(d\|H0) but it really doesn't matter. Become a Bayesian just means using the algorithm, and again, most of us don't have strong algo preferences
