...
-   We will be using this idea A. LOT. This isn't Bayesian specific. Instead it is a way you should think about all models. It is often useful very to use (e.g., getting group values when using dummy's, testing contrasts, etc).
...
By feeding our model numbers we can accomplish a number of handy things. - individual level predictions (y-hats) - Plot/visualize predictions across X - Distribution/Standard errors at certain levels of X - Coefficients/parameters at different levels of X - Post hoc comparisons (more later)
